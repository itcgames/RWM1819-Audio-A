class Game
{
  ...
  constructor(){
    ...
    this.eventAudioManager = new AudioManager();
  ...
  */
  initWorld(){
    ...
    this.eventAudioManager.loadSoundFile("MouseClick", this.myAssets.data["Audio"]["MOUSECLICK"]);
    //GUI
    ...
    this.eventAudioManager.eventBasedAudio("mousedown", "MouseClick", false, this.sliderArr[0].value);
  ...
  */
   ...
   */
  onMouseDown(e){
   gameNamespace.game.eventAudioManager.playEvent("mousedown");
  }
}
